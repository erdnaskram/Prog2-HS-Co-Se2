...
//		launch(ComplexLayoutExample.class, args);
//	}
//
//	@Override
...
//		ImageView imageHouse = new ImageView(new Image(ComplexLayoutExample.class.getResourceAsStream("house.png")));
...
//				new Image(ComplexLayoutExample.class.getResourceAsStream("piechart.png")));
...
//					new Image(ComplexLayoutExample.class.getResourceAsStream("chart_" + (i + 1) + ".png")));
